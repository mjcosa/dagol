...
class PullUpPage extends StatefulWidget {
  ...
  @override
  State<PullUpPage> createState() => _BeginnerWorkoutPageState();
}

class _BeginnerWorkoutPageState extends State<PullUpPage> {
          ...
          children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: const DecorationImage(
                        image: AssetImage('assets/images/easyexercise7.jpeg'),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
            ...
            Container(
              ...
              child: const Row(
                ...
                children: [
                  InfoChip(icon: Icons.fitness_center, label: '2 Sets'),
                  InfoChip(icon: Icons.repeat, label: '5-7 Rep'),
                  InfoChip(icon: Icons.flash_on, label: 'Easy - Medium'),
                ],
              ),
            ),
